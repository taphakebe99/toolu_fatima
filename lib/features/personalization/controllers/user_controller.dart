...
class UserController extends GetxController {
  ...
  Future<void> saveUserRecord(
    ...
    try {
      ...
      MyLoaders.warningSnackBar(
        ...
        message:
            'Un problème est survenu lors de la sauvegarde de vos informations. Vous pouvez réessayer plus tard dans votre profil.',
      );
    }
  }
  ...
  uploadUserProfilePicture() async {
    try {
      ...
      MyLoaders.errorSnackBar(
          title: 'Oops!', message: 'Une erreure est survenue: $e');
    }
  }
  ...
  void deleteAccountWarningPopup() {
    Get.defaultDialog(
      ...
      middleText:
          'Êtes-vous sûr de vouloir supprimer votre compte de façon permanente ? Cette action est irréversible et toutes vos données seront définitivement supprimées.',
  ...
  void deleteUserAccount() async {
    try {
      ...
      final isUserAnonymous = auth.firebaseUser!.isAnonymous;
  ...
  Future<void> reAuthenticateEmailAndPasswordUser() async {
    try {
      MyFullScreenLoader.openLoadingDialog(
          'En cours...', MyImages.docerAnimation);
